...
if __name__ == '__main__':
    filename = "LowLowResVideo.mp4"
    output = "butterfly_5_frames_start_250_YUV.npy"
    PreProcessVideo('yuv444p', filename, output)
    output = "butterfly_5_frames_start_250_RGB.npy"
    PreProcessVideo('rgb24', filename, output)
